...
const steps = [
  {
    number: "01",
    title: "Nhắn Zalo xin bản dùng thử",
    desc: "Liên hệ Zalo để xin bản dùng thử; bạn sẽ nhận file cài phù hợp Windows hoặc macOS.",
    icon: (
  ...
  },
  {
    ...
    desc: 'Mở file cài đặt, bấm "Tiếp theo" vài lần. ClawDesktop tự cài OpenClaw và skill.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-8 w-8" aria-hidden="true">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 flex justify-center">
          <a
            ...
            className="flex cursor-pointer items-center gap-2 rounded-full bg-neon-green px-8 py-3.5 text-base font-bold text-black shadow-lg transition-all hover:opacity-90 hover:shadow-[0_0_30px_rgba(0,255,157,0.4)]"
          >
