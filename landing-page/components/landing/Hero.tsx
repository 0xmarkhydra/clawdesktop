      ...
      <div ref={ref} className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8 fade-in-up">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 rounded-full bg-[#0068FF] px-7 py-3 text-sm font-bold text-white shadow-lg transition-all hover:opacity-90 hover:shadow-[0_0_30px_rgba(0,104,255,0.5)]"
          >
